                ...
                <div class="media-input-wrapper">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button 
                            ...
                            title="Parcourir les fichiers locaux"
    ...
    document.addEventListener('change', (e) => {
        if (e.target.type === 'radio' && e.target.name.endsWith('_mode')) {
            ...
            if (e.target.value === 'local') {
                // Mode Local
                input.readOnly = true;
                input.placeholder = "Cliquez sur Parcourir pour choisir un fichier";
                input.value = ''; // Réinitialiser la valeur quand on change de mode
