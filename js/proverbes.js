...
const proverbsAfricains = [
    ...
    "« Le savoir-faire est une lampe qui ne s'éteint jamais ; même quand l'artisan vieillit, ses gestes enseignent encore, et ses œuvres parlent for lui. »",
...
function initProverbes() {
    ...
    proverbeInterval = setInterval(changeProverbe, 10000);
}
...
function changeProverbe() {
    ...
    setTimeout(() => {
        // Repositionnement invisible à gauche
