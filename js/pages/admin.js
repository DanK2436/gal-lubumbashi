...
import { loadAnalyticsDashboard, cleanupAnalytics } from './admin-analytics.js';
...
async function loadPage(page) {
    ...
    try {
        ...
        // Cleanup analytics if leaving analytics page
        if (page !== 'analytics') {
            cleanupAnalytics();
        }
        ...
        switch (page) {
            ...
            case 'conceptions':
                ...
                break;
            case 'analytics':
                main.innerHTML = await loadAnalyticsDashboard();
                break;
            default:
                main.innerHTML = await renderDashboard();
                initDashboardHandlers();
